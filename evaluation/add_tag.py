...
def add_tag_sysout_all(java_path, tag_index, onclick_index):
    tag_strings = ['public void', 'public static void', 'void', 'private void',
        ...
        for index in range(len(lines)):
            ...
            for tag in tag_strings:
                if line.startswith(tag):
                    ...
                    break
            if status:
                if '(' in line and ')' in line and ';' not in line and '=' not in line and 'abstract' not in line\
                        and '}' not in line:
                    ...
                    replace_string = 'java.lang.System.out.println("method {0}");  \n'.format(str(tag_index))
                    cur_line = cur_line + replace_string
                    tag_index += 1
                    if onclick_status:
                        replace_click_string = 'java.lang.System.out.println("onclick {0}");  \n'.format(str(onclick_index))
    ...
    for root, dirs, files in os.walk(dir):
        for file in files:
            if str(file).endswith('.java'):
                ...
                tag_index, onclick_index = add_tag_sysout_all(file_path, tag_index, onclick_index)
...
if __name__ == '__main__':
    ...
    tag_index = 0
    dir = r'/Users/hhuu0025/PycharmProjects/guidedExplorer/data/source_code_apks/NoSurfForReddit-master'
