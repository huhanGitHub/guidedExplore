...
class ParamGenerator:
    ...
    def merge_deeplinks_params(self, deeplink_json,
                               merged_path=r'/Users/ruiqidong/Desktop/chunyang/guidedExplore/data/deeplinks_params.json'):
        params = 'params'
...
if __name__ == '__main__':
    params_path = r'/Users/ruiqidong/Desktop/chunyang/guidedExplore/data/intent_para.json'
    params = ParamGenerator(params_path)
    deeplinks_json = r'/Users/ruiqidong/Desktop/chunyang/guidedExplore/data/deeplinks.json'
