...
def unit_sign_APK(apk_path):
    print('sign ' + apk_path)
    cmd3 = '/Users/xxx/Downloads/SDK/build-tools/30.0.3/apksigner sign --ks /Users/xxx/.android/debug.keystore --ks-pass pass:android --key-pass pass:android ' + apk_path
    os.system(cmd3)
